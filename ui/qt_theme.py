...
QWidget#monitorPage QLabel {{ font-size: 13px; }}
QWidget#monitorPage QLabel#sectionTitle {{ font-size: 18px; }}
QWidget#monitorPage QPushButton {{ min-height: 40px; font-size: 13px; }}
QWidget#monitorPage QPushButton#selectionModeButton {{ color: {tokens.accent}; border-color: {tokens.accent}; }}
QWidget#monitorPage QPushButton#selectionModeButton:checked {{ color: {tokens.on_accent}; }}
...
QPushButton#selectionModeButton:checked {{
    color: {tokens.on_accent};
    background: {tokens.accent};
    border-color: {tokens.accent};
}}
QPushButton#selectionModeButton:checked:hover {{ background: {tokens.accent_hover}; }}
